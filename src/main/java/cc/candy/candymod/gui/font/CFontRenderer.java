package cc.candy.candymod.gui.font;
...
public class CFontRenderer extends CFont{
    ...
    public float drawStringWithShadow(String text, double x, double y, int color ,  float scale) {
        float shadowWidth = this.drawString(text, x + 1.0, y + 1.0, color, true , scale);
        return Math.max(shadowWidth, this.drawString(text, x, y, color, false , scale));
    }

    public float drawString(String text, float x, float y, int color , float scale) {
        return this.drawString(text, x, y, color, false , scale);
    }

    public float drawCenteredString(String text, float x, float y, int color , float scale) {
        return this.drawString(text, x - (float)(this.getStringWidth(text) / 2), y, color , scale);
    }

    public float drawCenteredStringWithShadow(String text, float x, float y, int color , float scale) {
        float shadowWidth = this.drawString(text, (double)(x - (float)(this.getStringWidth(text) / 2)) + 1.0, (double)y + 1.0, color, true , scale);
        return this.drawString(text, x - (float)(this.getStringWidth(text) / 2), y, color , scale);
    }
